                    ...
                    <tbody class="divide-y divide-gray-700">
                        ...
                        @foreach ($tickets as $ticket)
                            <tr class="bg-gray-800 hover:bg-gray-700">
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">#{{ $ticket->id }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ $ticket->title }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ $ticket->categories->name }}</td>
                                <td
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ $ticket->users->name}}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-gray-300">{{ $ticket->agent->name ?? 'No agent assigned' }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="{{ route('tickets.edit', $ticket->id) }}"
                                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mr-2">Voir</a>
                                    <button
                                        class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">Éditer</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
