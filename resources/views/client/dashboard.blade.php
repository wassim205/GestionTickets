    ...
    <div class="p-6">
        ...
        <section class="mb-6">
            ...
            <button id="createTicketButton"
                class="bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-blue-700 transition duration-200 ease-in-out">
                Nouveau Ticket
            </button>
        </section>
            ...
            <form action="/tickets" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="title" name="title"
                        class="mt-1 block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:text-gray-300 dark:focus:border-blue-500"
                        required>
                </div>
                <div class="mb-6">
                    <label for="category"
                        class="block text-lg font-medium text-gray-700 dark:text-gray-300">Catégorie</label>
                ...
                <div class="mb-6">
                    <label for="description"
                        class="block text-lg font-medium text-gray-700 dark:text-gray-300">Description</label>
                ...
                <div class="flex items-center justify-between">
                    <button type="submit"
                        class="bg-green-600 text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-green-700 transition duration-200 ease-in-out">
                        Soumettre le Ticket
                    </button>
                    <button type="button" id="cancelButton"
                        class="ml-4 bg-red-600 text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-red-700 transition duration-200 ease-in-out">
                        Annuler
                    </button>
                </div>
            </form>
                ...
                <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800">
                    ...
                    <tbody class="bg-white dark:bg-gray-800">
                       ...
                       @foreach ($tickets as $ticket)
                            <tr>
                                <td class="border px-4 py-2 text-gray-800 dark:text-gray-200">{{ $ticket->title }}</td>
                                <td class="border px-4 py-2 text-gray-800 dark:text-gray-200">{{ $ticket->categories->name }}</td>
                                <td
                                    class="border px-4 py-2 text-{{ $ticket->status->name === 'resolved' ? 'green' : ($ticket->status->name === 'pending' ? 'yellow' : 'red') }}-400">
